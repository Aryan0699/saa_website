...
export default function Legacy() {
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <Helmet>
        <title>Legacy</title>
        <meta name="description" content="Welcome to the Legacy website" />
      </Helmet>
      ...
      <main className="relative z-10 max-w-3xl px-6 py-10 text-center">
        ...
        <p className="text-lg text-gray-200 max-w-2xl mx-auto mb-8">
          This is the official Legacy page. The background is an animated particles effect that adapts to light/dark theme.
        </p>
