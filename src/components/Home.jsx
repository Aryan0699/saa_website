...
const Home = () => {
  return (
    <div className="w-full min-h-screen bg-gradient-to-br dark:bg-transparent flex flex-col items-center px-4 sm:px-6 lg:px-8">

      <div className="relative w-full max-w-6xl pb-6 sm:pb-8 mt-24 sm:mt-32  lg:mt-32 rounded-2xl sm:rounded-3xl dark:border-white/10 
        ...
        <div className="flex items-center justify-center flex-col overflow-hidden px-4 sm:px-6 lg:px-8">
          ...
          />
          <p className="w-full max-w-4xl text-sm sm:text-[14ypx] md:text-[16px] text-gray-600 dark:text-white/80 text-center mx-auto sm:mb-6 lg:mb-8 leading-relaxed">
