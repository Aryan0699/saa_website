...
export default function MemoirsLane() {
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      {/* Meta tags */}
      <Helmet>
        <title>Memoirs Lane</title>
        <meta name="description" content="Welcome to the Memoirs Lane website" />
      </Helmet>
      ...
      <main className="relative z-10 max-w-3xl px-6 py-10 text-center">
        <h1 className="text-5xl font-bold mb-6 text-blue-500 drop-shadow-lg">
          Welcome to the Memoirs Lane
        </h1>
        <p className="text-lg text-gray-200 max-w-2xl mx-auto mb-8">
          This is the official Memoirs Lane page. The background is an animated particles effect that adapts to light/dark theme.
        </p>
      ...
      <footer className="absolute bottom-4 text-gray-400 text-sm z-10">
        © {new Date().getFullYear()} Memoirs Lane. All rights reserved.
      </footer>
    </div>
  );
}
