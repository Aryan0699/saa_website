...
function ThemeBtn() {
    ...
    return (
        <motion.button
            ...
            className={`xl:m-8 p-0 sm:p-2 rounded-full flex items-center justify-center  shadow-md transition-colors duration-200 ${isDarkMode ? 'bg-gray-800' : 'bg-yellow-300'
                }`}
